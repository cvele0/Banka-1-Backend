...
public class StockSimulationJob implements Runnable {
    ...
    private void processOrder(
        ...
        Long processedNumber = (order.getAllOrNone()
                || order.getListingType().equals(ListingType.FUTURE) || order.getListingType().equals(ListingType.FOREX)
                || order.getListingType().equals(ListingType.OPTIONS)) ? order.getContractSize() : Math.min(
